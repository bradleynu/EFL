...
class Elex_Address_Autocomplete_Validation_Settings extends WC_Settings_Page {
	...
	public function elex_api_credentials_settings() {
		$settings = array(
			...
			'ups_api selector'               => array(
				'title'    => __( 'UPS APIs', 'wf-address-autocomplete-validation' ),
				'type'     => 'select',
				'css'      => 'padding: 0px;',
				'default'  => 'old_ups_api',
				'desc'     => __( 'Choose the UPS API', 'wf-address-autocomplete-validation' ),
				'desc_tip' => true,
				'custom_attributes' => array( 'disabled' => 'disabled' ),
				'options'  => array(
					'old_ups_api' => __( 'UPS Access Key Integration', 'wf-address-autocomplete-validation' ),
					'new_ups_api' => __( 'UPS OAuth Integration', 'wf-address-autocomplete-validation' ),
				),
			),
			...
			'usps_api selector'              => array(
				'title'    => __( 'USPS APIs', 'wf-address-autocomplete-validation' ),
				'type'     => 'select',
				'css'      => 'padding: 0px;',
				'default'  => 'old_usps_api',
				'desc'     => __( 'Choose the USPS Address Validation API Integration', 'wf-address-autocomplete-validation' ),
				'desc_tip' => true,
				'custom_attributes' => array( 'disabled' => 'disabled' ),
				'options'  => array(
					'old_usps_api' => __( 'USPS Legacy API Integration', 'wf-address-autocomplete-validation' ),
					'new_usps_api' => __( 'USPS OAuth 3.0 API Integration', 'wf-address-autocomplete-validation' ),
				),
			),
