...
class Init {
	...
	public function load_assets() {
		...
		if ( method_exists('\AdvancedAds\Utilities\Conditional', 'is_screen_advanced_ads') && \AdvancedAds\Utilities\Conditional::is_screen_advanced_ads()
			|| \Advanced_Ads_Admin::screen_belongs_to_advanced_ads()) { // Using deprecated function for backwards compatiblity. E.g. in case customers update AAWP plugin but using AdAds below 1.4.7.
