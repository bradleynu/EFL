...
class Init {
	...
	public function screen_options() {
		...
		do_action( 'aawp_clicks_listtable_init', $listtable );
	}
	...
	public function render_page() {
		...
		$pages = apply_filters( 'aawp_clicks_pages', [ 'Clicks', 'Settings', 'Export' ] );
		...
		// Display respective pages or Clicks Overview.
		if ( ! empty( $_GET['section'] ) && 'clicks' !== $_GET['section'] ) { //phpcs:ignore WordPress.Security.NonceVerification.Recommended

			$class = 'AAWP\\ClickTracking\\' . ucfirst( $_GET['section'] );
