...
function aawp_get_prime_check_logo( $atts = array() ) {
    ...
    // Exception: Japan
    if ( 'co.jp' === $country ) {
        $prime_logo = '<img src="'. AAWP_PLUGIN_URL .'assets/img/icon-check-prime-jp.svg" height="16" width="55" alt="'. esc_html( $title ) .'" />';

    // Default
    } else {
        $prime_logo = '<img src="'. AAWP_PLUGIN_URL .'assets/img/icon-check-prime.svg" height="16" width="55" alt="'. esc_html( $title ) .'" />';
    }
