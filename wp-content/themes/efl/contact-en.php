...
<div class="container">
    <div class="row">
        <div class="col-md-12 mapcontact">
            <?php echo do_shortcode('[ultimate_maps id="2"]'); ?>
        </div>
    </div>
    <div class="row" style="padding-bottom: 90px;">
        <div class="col-md-6">
            <div class="contact-form-content">
                ...
                <div class="media-body"><a href="tel:305 805 3456">Call: 305 805 3456</a></div>
                </div>
                <div class="media">
                ...
                <div class="media-body">Monday to Friday from<br>
                9:00 a.m. to 5:00 p.m. EST</div>
                </div>
            </div>
            <div class="contact-form-content">
                <p><small>Customer service & Returns and refunds</small><br>
                <a href="mailto:info@efficientlabs.com">info@efficientlabs.com</a></p>
            </div>
        </div>
        <div class="col-md-6">
            <?php echo do_shortcode('[contact-form-7 id="42213" title="Contact form en"]'); ?>
        </div>
    </div>
</div>
