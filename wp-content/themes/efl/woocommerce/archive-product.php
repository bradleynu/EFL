...
<?php endif ?>
<?php
// Verificar si estamos en la página de categoría correcta
$current_url = home_url( $_SERVER['REQUEST_URI'] );
$es_category_url = 'https://efficientlabs.com/es/product-category/tos-gripe/rompepecho/';
$en_category_url = 'https://efficientlabs.com/en/product-category/cough-cold/rompepecho-en/';

// Comprobar si estamos en la página de categoría de Rompe Pecho
if (strpos($current_url, '/es/product-category/tos-gripe/rompepecho/') !== false || 
    strpos($current_url, '/en/product-category/cough-cold/rompepecho-en/') !== false) {
    
    // Verificar el idioma actual usando Polylang
    if (function_exists('pll_current_language')) {
        ...
        // Mostrar el iframe
        if (!empty($iframe_url)) {
            echo '<div class="rompe-pecho-comparison-table-container">';
           
            echo '<iframe src="' . esc_url($iframe_url) . '" width="100%" height="900" frameborder="0" style="margin-top: 30px; margin-bottom: 30px;"></iframe>';
            echo '</div>';
        }
    }
}
