		...
		<address>
			<?php
				...
				if ( ! $formatted_address )
					...
					<?php echo $address['city'] . ' ' . $address['state'] . ' ' . $address['province'] . ' ' . $address['country'] ?> </p>
					<?php
				}
			?>
		</address>
		<hr>
		<a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', $name ) ); ?>" class="btn btn-success btn-lg edit"><?php _e( 'Edit', 'woocommerce' ); ?> <?php echo strtolower($title) ?></a>
	</div>
	<br>
